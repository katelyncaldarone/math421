...
ggsave(filename = 'VarImp1.png', plot = last_plot())
```
...
```{r}
plot(glm)
ggsave(filename = 'glm1.png', plot = last_plot())
```

```{r}
plot(fda)
ggsave(filename = 'fda1.png', plot = last_plot())
```
...
ggsave(filename = 'decisiontree2.png', plot = gg)
```
